<div class="modal fade" id="actualizarUbicacionModal" tabindex="-1" aria-labelledby="actualizarUbicacionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <form method="POST" action="{{ route('productos_compra_venta.actualizarUbicacion', $productoCompraVenta->id) }}" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
            <div class="modal-content border-0 shadow-lg rounded-3 overflow-hidden">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea class="form-control shadow-sm" id="comentarioInput" name="comentario" rows="3" placeholder="Ingrese un comentario opcional...">{{ old('comentario', $productoCompraVenta->comentario) }}</textarea>
                    </div>
                </div>
